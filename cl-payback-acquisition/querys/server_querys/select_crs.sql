select
	...
	, case 
		...
		when v.code in ('CL_SMALLMX_FREE_AIR', 'CL_SMALLMX_FREE_SOLO','CL_INTERNALSALES_AIR', 'CL_INTERNALSALES_SOLO', 'CL_EXTERNALSALES_BST_AIR', 'CL_EXTERNALSALES_GYT_AIR', 'CL_EXTERNAL SALES_BST_SOLO', 'CL_EXTERNAL SALES_GYT_SOLO') THEN 'SMX'
		when v.code ilike  'CL_IS_SOLO_SRSOL%%' then 'SMX' 
